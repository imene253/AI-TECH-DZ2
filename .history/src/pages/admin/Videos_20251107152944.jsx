...
const Videos = () => {
  ...
  const onCreate = async (e) => {
    ...
    setLoading(true); setError('');
    try {
      // Create FormData for multipart/form-data if video file is provided
      if (form.videoFile) {
        const formData = new FormData();
        formData.append('Title', form.title || 'Video');
      ...
      <div className="bg-white p-4 rounded border mb-6 w-full max-w-2xl">
        ...
        <div className="grid grid-cols-1 gap-3">
          ...
          <div className="border-t pt-3">
            <p className="text-sm text-gray-600 mb-2">Choose one option:</p>
            ...
            <div className="space-y-3">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Video URL (YouTube, direct link, etc.)
                </label>
                <input 
        ...
        <button 
          onClick={onCreate}
          disabled={loading || (form.chapterId === 0) || (!form.videoFile && !form.url)}
